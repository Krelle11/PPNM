...
System.Console.Out.WriteLine("");
System.Console.Out.WriteLine("lets see whether the product of Q with R is equal to B...");
...
for (int i = 0; i < M.size1; i++) {
        for (int j = 0; j < M.size2; j++) {
                System.Console.Out.WriteLine($"({i},{j})'th entrance of M is: {M[i, j]}");
               }
}
...
System.Console.Out.WriteLine(M.approx(B));
